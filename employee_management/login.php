  ...
  <body>
   ...
   <div style=text-align:center;>
    ...
    <form class="" action="" method="post">
      <p>ID<input type="text" name="member_id" value="<?php echo htmlspecialchars($_POST['member_id'],ENT_QUOTES);?>"></p>
      ...
      <p><a href="M_login.php">管理者用ページはこちらから</a></p>
    </div>
    </form>
  </body>
</html>
